...
class PlayerTab(wx.Panel):
    ...
    def add_controls(self):
        ...
        self.play_pause_btn = buttons.GenBitmapToggleButton(self, bitmap=img, name="play", size=wx.DefaultSize, pos=(158, 10))
        ...
        btn_data = [
            {'bitmap': 'player_next.png',
                    ...
                    #,
                    # {'bitmap': 'player_repeat.png',
                    #  'handler': self.on_next, 'name': 'repeat',
                    #  'size': (50, 50), 'pos': (250, 10)}
        ]
        for btn in btn_data:
            self.build_btn(btn)
